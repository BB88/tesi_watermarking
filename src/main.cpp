...
//    cv::Mat disp_after_mark = imread("/home/miky/Scrivania/disparity_after_watermark.png", CV_LOAD_IMAGE_GRAYSCALE);


//    cv::Mat kz_disp = imread("/home/miky/ClionProjects/tesi_watermarking/img/kz_disp.png", CV_LOAD_IMAGE_GRAYSCALE);
//    if (kz_disp.rows == 0){
//        cout << "Empty image";
//    } else {
//        Disp_opt dp;
...
//
//    Right_view rv;
//    rv.right_reconstruction(left_marked, disp);
...
*/
    ...
    /*  PROCESSO MARCHIATURA IMMAGINE SINISTRA */
//
...
//
//    /*  FINE MARCHIATURA IMMAGINE SINISTRA */
//
//
// /* VEDERE IL MARCHIO NELLA SINISTRA */
//
...
///* splits the image into 3 channels and normalize to see watermark */
    ...
    /* FINE VEDERE IL MARCHIO NELLA SINISTRA */


 /* PROCESSO MARCHIATURA IMMAGINE DESTRA */
//
    cv::Mat disp = imread("/home/miky/ClionProjects/tesi_watermarking/img/nkz_right_dim_disp.png", CV_LOAD_IMAGE_GRAYSCALE);
//
...
/* FINE MARCHIATURA IMMAGINE DESTRA */
