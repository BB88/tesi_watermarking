...
public:
    LMRectify(const std::vector<imgMatch>& m, int w, int h)
...
private:
    const std::vector<imgMatch>& m_matches; ///< Set of matches
                          ...
                          vector<flnum>& ymodel) const
{
    ...
    std::vector<imgMatch>::const_iterator it = m_matches.begin();
